...
public class AboutLambdas {
    ...
    public void simpleLambda() {
        ...
        assertEquals(capitalized, capitalized);
    }
    ...
    public void lambdaField() {
        assertEquals(thisLambdaField.capitalize(""), thisLambdaField.capitalize(""));
    }

    @Koan
    public void lambdaField2() {
        assertEquals(toStringLambdaField.capitalize(""), toStringLambdaField.capitalize(""));
    }
    ...
    public void effectivelyFinal() {
        ...
        assertEquals(caps.capitalize(effectivelyFinal), caps.capitalize(effectivelyFinal));
    }
    ...
    public void thisIsSurroundingClass() {
        ...
        assertEquals(foo.apply("|"), foo.apply("|"));
    }
